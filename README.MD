## To run this project locally - create .env file at the root folder and set up the following enviromental variable:
...
-   [] setup start port variable (4000) and start function
